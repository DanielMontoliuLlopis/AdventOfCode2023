...
public class Day2_2 {
    ...
    public static void main(String[] args) {
        ...
        for (List<String> splitedLine:
            ...
            int potency = sumAndCheckSets(sets);
                sum += potency;
    ...
    static int sumAndCheckSets(List<String> sets) {
        int maxBlueCount = 0;
        int maxRedCount = 0;
        int maxGreenCount = 0;
        for (String set:
            ...
            if(blueCount > maxBlueCount) maxBlueCount = blueCount;
            if(redCount > maxRedCount) maxRedCount = redCount;
            if(greenCount > maxGreenCount) maxGreenCount = greenCount;
